/** @fichier mainpage.h
* @brief Page prinicpale du projet
* @Copyright Modèle de base à partir de Dioxygen
*/
/** @mainpage Projet de Programmation C
*
*  \brief     3A STI.
*  \details   Simultation d'écosystème aquatique et jeu de pêche sur principe de traversée de la map.
*  \author    Amine MADDAH
*  \author    FARAON Clement
*  \version   0.99
*  \date      2014
